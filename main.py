...
def get_args_parser():
    ...
    # 추가된 시각화 관련 인자들
    parser.add_argument('--visualize', action='store_true', help='Visualize an image instead of training')
    parser.add_argument('--visualize_index', type=int, default=0, help='Index of the image to visualize')  # 기본값 0 설정
